...
export default function Dashboard({ user }) {
    // In case of teachers -> There will be no home but will be announcement,
    // In case of student -> both home and announcements
    // For teacher:
    // The channels will be each lecture that teacher is involved in
    // For student:
    // The channels will be each lecture that class is involved in
